...
namespace NagadPayment\Controller\Component;
...
class PaymentComponent extends Component
{
  ...
  public function validateCheckout($request){
   // call validation of checkout form then call actual  payment
      ...
      if (empty($request->getData('nagad_transaction_number')) || empty($request->getData('nagad_number'))){
  ...
  public function afterCheckout($request, $order){
      ...
      $data =[
        'order_id' => $order->order_id,
          'transaction_number' => $request->getData('nagad_transaction_number'),
        'payment_data' => json_encode(['nagad_number' => $request->getData('nagad_number'), 'transaction_number' => $request->getData('nagad_transaction_number') ])
      ];
