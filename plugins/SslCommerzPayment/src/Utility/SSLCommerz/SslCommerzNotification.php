...
//                 }
    ...
    {
        $this->successUrl = Router::url('/ssl-commerz-payment',true) . '/' . $this->config['success_url'];
    }
    ...
    {
        $this->failedUrl = Router::url('/ssl-commerz-payment',true) . '/' . $this->config['failed_url'];
    }
    ...
    {
        $this->cancelUrl = Router::url('/ssl-commerz-payment',true) . '/' . $this->config['cancel_url'];
    }
    ...
    public function setRequiredInfo(array $info)
    {
         ...
         * */
        $this->data['ipn_url'] = Router::url('/ssl-commerz-payment',true) . '/' . $this->config['ipn_url'];
