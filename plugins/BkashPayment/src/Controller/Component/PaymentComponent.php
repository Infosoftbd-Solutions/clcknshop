...
namespace BkashPayment\Controller\Component;
...
class PaymentComponent extends Component
{
  ...
  public function validateCheckout($request){
   // call validation of checkout form then call actual  payment
      ...
      if (empty($request->getData('bkash_transaction_number')) || empty($request->getData('bkash_number'))){
  ...
  public function afterCheckout($request, $order){
      ...
      $data =[
          ...
          'transaction_number' => $request->getData('bkash_transaction_number'),
          'payment_data' => json_encode(['bkash_number' => $request->getData('bkash_number'), 'transaction_number' => $request->getData('bkash_transaction_number') ])
      ];
