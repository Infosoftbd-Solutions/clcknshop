...
class OrderStatusFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'status_id' => ['type' => 'integer', 'length' => 10, 'unsigned' => true, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        'created' => ['type' => 'datetime', 'length' => null, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null],
        'updated' => ['type' => 'datetime', 'length' => null, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null],
        '_indexes' => [
            'order_status_FKIndex1' => ['type' => 'index', 'columns' => ['orders_id'], 'length' => []],
        ],
        '_constraints' => [
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'status_id' => 1,
                'created' => '2020-07-04 03:21:13',
                'updated' => '2020-07-04 03:21:13',
            ],
        ];
        parent::init();
    }
