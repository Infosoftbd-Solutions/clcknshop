...
class ReviewsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'comment' => ['type' => 'text', 'length' => 4294967295, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'status' => 1,
                'created' => '2021-01-10 05:29:51',
                'updated' => '2021-01-10 05:29:51',
            ],
        ];
        parent::init();
    }
