...
class CouponsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'coupon_code' => ['type' => 'string', 'length' => 20, 'null' => false, 'default' => null, 'collate' => 'utf8mb4_unicode_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'condition' => ['type' => 'text', 'length' => 4294967295, 'null' => false, 'default' => null, 'collate' => 'utf8mb4_unicode_ci', 'comment' => '', 'precision' => null],
        ...
        'max_amount' => ['type' => 'decimal', 'length' => 10, 'precision' => 2, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => ''],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'start_date' => '2020-12-22 11:05:13',
                'end_date' => '2020-12-22 11:05:13',
                'discount_type' => 1,
                'discount' => 1.5,
                'max_amount' => 1.5,
                'status' => 1,
                'created' => '2020-12-22 11:05:13',
                'modified' => '2020-12-22 11:05:13',
            ],
        ];
        parent::init();
    }
