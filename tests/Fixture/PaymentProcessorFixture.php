 ...
 */
class PaymentProcessorFixture extends TestFixture
{
    /**
     * Table name
     *
     * @var string
     */
    public $table = 'payment_processor';
    /**
     * Fields
     *
     * @var array
    ...
    public $fields = [
        ...
        'options' => ['type' => 'text', 'length' => null, 'null' => false, 'default' => null, 'collate' => 'utf8mb4_unicode_ci', 'comment' => '', 'precision' => null],
