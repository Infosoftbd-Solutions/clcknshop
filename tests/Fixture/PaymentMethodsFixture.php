...
class PaymentMethodsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'options' => ['type' => 'text', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'status' => 1,
                'created' => '2020-10-14 09:51:52',
                'modified' => '2020-10-14 09:51:52',
            ],
        ];
        parent::init();
    }
