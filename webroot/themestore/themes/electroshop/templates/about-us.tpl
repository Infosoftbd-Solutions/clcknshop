<main class="main">
    <div class="page-header page-header-bg text-left" style="background: 70%/cover #D4E1EA url('{{ Shop.asset_image(about-us-page-hero-image)}}');">
        <div class="container">
            <h1><span>ABOUT US</span>
                Clcknshop</h1>
            <a href="page/contact-us" class="btn btn-dark">Contact</a>
        </div><!-- End .container -->
    </div><!-- End .page-header -->
    ...
    <div class="features-section" style="background-color: #f2f2f2f2">
        <div class="container">
