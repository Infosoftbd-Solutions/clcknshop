		...
		<nav aria-label="breadcrumb" class="breadcrumb-nav">
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item"><a
						href="/collection/all?product_type={{product->product_type}}">{{product->product_type}}</a></li>
			</ol>
		</nav>
					...
					<div class="product-slider-container">
						<div class="product-single-carousel owl-carousel owl-theme">
							<div class="product-item" tpleach="product->product_media">
								<img class="product-single-image" src="" tplimage="val->image"
									data-zoom-image="/{{val->image}}" />
							</div>
						</div>
				...
				<div class="col-md-7 product-single-details">
					...
					<div class="ratings-container">
						<div class="product-ratings">
							<span class="ratings" style="width:{{Formats.mul(20, $product->rating)}}%"></span>
							<!-- End .ratings -->
						</div><!-- End .product-ratings -->

						<a href="#product-reviews-content" class="rating-link">(<tpl tplvar="product->rating_total">
							</tpl> reviews)</a>
					...
					<form action="add_to_cart" tplform="">
						...
						<div class="product-filters-container" tpleach="product->product_options" set="option">
							<div class="product-single-filter mb-2">
								...
								<ul class="config-size-list">
									<li tpleach="Formats.split($option->option_values)" set="option_value"><a
											href="javascript:void(0)" class="option_selected"
											data-name="{{ option->option_name }}" data-value="{{ option_value }}">{{
											option_value }}</a></li>
									<!--class="active" -->
								</ul>
						...
						<div class="product-action">
							...
							<button class="btn btn-dark add-cart icon-shopping-cart" title="Add to Cart">Add to
								Cart</button>
			...
			<ul class="nav nav-tabs" role="tablist">
				...
				<li class="nav-item">
					<a class="nav-link" id="product-tab-reviews" data-toggle="tab" href="#product-reviews-content"
						role="tab" aria-controls="product-reviews-content" aria-selected="false">Reviews (<tpl
							tplvar="product->ratingTotal"></tpl>)</a>
				</li>
			</ul>
									...
									<li class="comment-container" tpleach="product->reviews" set="review">
										...
										<div class="comment-box">
											<div class="ratings-container">
												<div class="product-ratings">
													<span class="ratings"
														style="width:{{Formats.mul(20, $review->rating)}}%"></span>
													<!-- End .ratings -->
												</div><!-- End .product-ratings -->
											</div><!-- End .ratings-container -->

											<div class="comment-info mb-1">
												<h4 class="avatar-name">{{ review->customer->first_name }} {{
													review->customer->last_name }}</h4> - <span class="comment-date">{{
													review->created }}</span>
								...
								<div class="add-product-review" tpluser="1">
									<form action="review" class="comment-form m-0" tplform="">
										...
										<div class="form-group">
											...
											<textarea cols="5" rows="6" name="comment"
		...
		<div class="products-section pt-0">
			...
			<div class="products-slider owl-carousel owl-theme dots-top">
				<div class="product-default inner-quickview inner-icon"
					tpleach="Shop.products(all, product_type:$product->product_type, limit:2)">
					<figure>
						<a href="{{ val->link }}">
							<img src="images/products/product-14.jpg" tplimage="val->imagepath">
						</a>
						<div class="btn-icon-group">
							<a class="btn-icon btn-add-cart" href="{{val->cartlink}}" ><i
