			...
			<div class="row">
				...
				<div class="col-md-12">
					<div class="row">
						...
						<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12" tpleach="products">

							<div class="single-product">

								<img class="ck-pro-image" style="display: none" src=""  tplimage="val->imagepath" width="320" height="390"/>
								<span class="ck-pro-description" style="display: none" tplvar="val->description"> </span>

								<div class="product-img">
									<span class="pro-label new-label">new</span>
									<span class="ck-pro-price pro-price-2" tplvar="val->price">$ 56.20</span>
									<a href="single-product.html" class="ck-link" tplvar="val->link"><img src="img/product/6.jpg" alt="" tplimage="val->imagepath" /></a>
								</div>
								<div class="product-info clearfix text-center">
									<div class="fix">
										<h4 class="ck-pro-title post-title"><a href="#" tplvar="val->link"><tpl tplvar="val->title"></tpl></a></h4>
									...
									<div class="product-action clearfix">
										...
										<a href="#" class="ck-cartlink" tplvar="val->cartlink" data-toggle="tooltip" data-placement="top" title="Add To Cart"><i class="zmdi zmdi-shopping-cart-plus"></i></a>
									</div>
								</div>
							</div>
						</div>
