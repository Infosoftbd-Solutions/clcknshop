            ...
            <tr>
                <td class="content-cell">
                    <div class="f-fallback">
                        ...
                        <p>We are pleased to share that the item(s) from your order #<b><?= $order->order_id ?></b> have been Delivered.</p>
                        <p>
                            ...
                            <tr>
                                <td align="center">
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0" role="presentation">
                                        <tr>
                                            <td align="center">
                                                <a style="color: #FFFFFF !important;"  href="<?= $this->Url->build("", true); ?>" class="f-fallback button button--green" target="_blank">Write A Review</a>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
