            ...
            <tr>
                <td class="content-cell">
                    <div class="f-fallback">
                        ...
                        <p>Thank you for ordering from <?= $store->title ?>.</p>
                        <p>
                            We're excited for you to receive your order <b>#<?= $order->order_id ?> </b> and will notify you once it's on its way. We hope you had a great shopping experience. You can check your order status here.
                        </p>
                        <!-- Action -->
                                ...
                                <td class="attributes_content">
                                    <table width="100%" cellpadding="0" cellspacing="0" role="presentation">
                                        ...
                                        <tr>
                                            <td class="attributes_item">
                                                <span class="f-fallback">
                                                    <strong>Total Due:</strong> <?= $this->Formats->moneyFormat(number_format( $order->order_total - $order->total_paid, 2))?>
                                                </span>
                                            </td>
                                        </tr>
                                    </table>
                                ...
                                <td colspan="2">
                                    <table class="purchase_content" width="100%" cellpadding="0" cellspacing="0">
                                        ...
                                        <tr>
                                            ...
                                            <td class="align-right" width="20%" class="purchase_item"><span class="f-fallback"><?= $this->Formats->moneyFormat($product->product_price * $product->product_quantity, false) ?></span></td>
                                        </tr>
                                        <?php endforeach; ?>
