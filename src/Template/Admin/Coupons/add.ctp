...
<div class="row">
    <div class="col-lg-12">
        ...
        <div class="categories form large-9 medium-8 columns content">
            <?= $this->Form->create(null,['action' => 'add', 'class'=>'card']) ?>
            <div class="card-header">
                <h4 class="card-title"><?= __('Add New Coupon') ?></h4>
            </div>
            <div class="card-body">
                <fieldset class="form-fieldset">
                    <div class="row px-3 mb-3">
                        <div class="col-md-9">
                            ...
                            <input type="text" name="title" class="form-control" placeholder="<?= __('Black Friday') ?>" id="title">
                        </div>
                        <div class="col-md-3">
                    ...
                    <div class="row px-3 pb-4">
                        <div class="col-md-6">
                            ...
                            <div class="input-icon">
                                <input id="start_date" name="start_date" type="text" class="form-control flatpickr-input datetimepicker" placeholder="<?= __('Select a date') ?>" readonly="readonly">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-icon">
                                <input id="end_date" name="end_date" type="text" class="form-control flatpickr-input datetimepicker" placeholder="<?= __('Select a date') ?>" readonly="readonly">
                                <span class="input-icon-addon">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                        <path stroke="none" d="M0 0h24v24H0z"></path>
                                        <rect x="4" y="5" width="16" height="16" rx="2"></rect>
                ...
                <fieldset class="form-fieldset">
                    <div class="row px-3 pb-4">
                        ...
                        <div class="col-md-6 col-lg-3">
                            ...
                            <input name="discount_amount" class="form-control" placeholder="100 / 5" required>
                        </div>

                        <div class="col-md-6 col-lg-3">
                            <label for="max_amount" class="form-label"><?= __('Maximum Amount') ?> </label>
                            <input name="max_amount" class="form-control" placeholder="500">
                        </div>

                        <div class="col-md-6 col-lg-3">
                            <?php echo $this->TablerForm->control('min_purchase_amount', ['placeholder' => '1000']); ?>
                        </div>
                    </div>
                </fieldset>

                <fieldset class="form-fieldset">
                    <h4><?= __('Products Selection') ?></h4>

                    <div class="form-group custom-radio">
                        <label class="custom-control">
                            <input type="radio"  checked name="product_selection_type" value="1" class="custom-control-input">
                            <span class="custom-control-label"><?= __('All Products') ?></span>
                        </label>

                        <label class="custom-control">
                            <input type="radio" name="product_selection_type" value="2" class="custom-control-input">
                            <span class="custom-control-label"> <?= __('Specific Product') ?>  </span>
                        </label>
                        <div id="specific_product_display" class="card d-none">
                            <div class="card-body">
                        ...
                        <label class="custom-control">
                            <input type="radio" name="product_selection_type" value="3" class="custom-control-input">
                            <span class="custom-control-label"> <?= __('Specific Collection') ?>  </span>
                        </label>

                        <div id="display_specific_collection" class="card d-none">
                            <div class="card-body">
                                <?php foreach ($collections as $collection): ?>
                                    <label class="form-check">
                                        <input class="form-check-input" value="<?= $collection->id ?>" type="checkbox" name="collections[]">
                ...
                <fieldset class="form-fieldset">
                    ...
                    <div class="form-group custom-radio">
                        <label class="custom-control">
                            <input type="radio" checked name="customer_selection_type" value="1" class="custom-control-input">
                            <span class="custom-control-label"><?= __('All Customers') ?></span>
                        </label>

                        <label class="custom-control">
                            <input type="radio" name="customer_selection_type" value="2" class="custom-control-input">
                            <span class="custom-control-label"> <?= __('Specific  Customer') ?>  </span>
                        </label>

                        <div id="specific_customer_display" class="card d-none">
                            <div class="card-body">
            ...
            <div class="card-footer text-right">
                ...
                <div class="d-flex">
                    ...
                    <button type="submit" class="btn btn-primary ml-auto"><?= __('Send data') ?></button>
                </div>
            </div>
