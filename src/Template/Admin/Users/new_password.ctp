                    ...
                    <div class="card">
                        ...
                        <div class="card-body p-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" name="password" class="form-control" required id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="<?= __('Enter New Password') ?>">
                            </div>

                            <div class="form-group">
                                <label class="form-label"><?= __('Confirm Password') ?></label>
                                <input type="password" name="confirm_password" class="form-control" required id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="<?= __('Enter Confirm Password') ?>">
                            </div>
