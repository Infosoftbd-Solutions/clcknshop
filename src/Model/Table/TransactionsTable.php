...
class TransactionsTable extends Table
{
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ->scalar('payment_data')
            ->requirePresence('payment_data', 'create')
            ->notEmptyString('payment_data');
    ...
    public function add($data){
        ...
        if($this->find()->where(["order_id"=>$data['order_id'],'transaction_number'=>$data['transaction_number']])->count() > 0) // transaction allready inserted
                 return false;
        $transaction = $this->newEntity();
        $transaction = $this->patchEntity($transaction, $data);
